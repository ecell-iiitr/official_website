  ...
  return (
    <div className="bg-white rounded-lg py-8 sm:py-16 px-6 sm:px-12 lg:px-24 flex flex-col xl:flex-row">
      ...
      <div className="w-full xl:w-3/5">
        <h1 className="text-xl xs:text-2xl md:text-3xl lg:text-4xl pb-4 font-body font-bold underline-offset-8 underline text-[#3498D9]">
          Startup Master Class
        </h1>
        <h6 className="text-[#AFB0B0] text-xs xs:text-sm md:text-base lg:text-lg font-bold font-body pb-6">May 2023 by Anuj Kr. Gupta</h6>
